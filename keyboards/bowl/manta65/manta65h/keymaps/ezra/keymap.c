...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_BSLS, KC_DEL,
        ...
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,            KC_RCTL,
        KC_LCTL, KC_LALT, MO(_FN),                            KC_SPC,                             _______, MO(_FN),          KC_LEFT, KC_DOWN, KC_RGHT,
        KC_LCTL, KC_LALT, MO(_FN)
    ),
