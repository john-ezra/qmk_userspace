...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT(
        ...
        FN_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_LBRC, KC_RBRC, KC_BSPC,          KC_PGUP,
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             _______, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
