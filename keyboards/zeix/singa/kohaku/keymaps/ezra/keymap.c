...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_65_ansi_blocker_tsangan(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                   KC_UP,   KC_RALT,
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                                      KC_RALT,          CTL_LFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_FN] = LAYOUT_65_ansi_blocker_tsangan(
        ...
        _______, _______, _______,                            KC_LCTL,                                     _______,          _______, _______, _______
    ),
};
