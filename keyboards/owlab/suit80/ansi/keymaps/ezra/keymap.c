...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_ansi(
        ...
        KC_LCTL, _______, MO(_FN),                            KC_SPC,                                      MO(_FN), _______, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_FN] = LAYOUT_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_UNDS, KC_LBRC, KC_RBRC, _______,          _______,                   _______,
