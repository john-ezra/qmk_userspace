...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_typek_visual(
        ...
        KC_END,  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(_FN),
    ...
    [_FN] = LAYOUT_typek_visual(
        ...
        KC_BRIU, _______, KC_HOME, _______, KC_END,  _______, _______,          UG_TOGG, UG_HUEU, UG_SATU, UG_VALU, UG_SPDU, UG_NEXT, _______, _______,
        KC_BRID, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,          _______, UG_HUED, UG_SATD, UG_VALD, UG_SPDD, UG_PREV,          _______,
