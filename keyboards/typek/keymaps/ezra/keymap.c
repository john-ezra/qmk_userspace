...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_typek_visual(
        ...
        KC_END,  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RALT,
    ...
    [_FN] = LAYOUT_typek_visual(
        ...
        KC_BRIU, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,          KC_TILD, KC_LCBR, KC_RCBR, _______, _______, _______, _______, _______,
        KC_BRID, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,          KC_MINS, KC_LPRN, KC_RPRN, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______,          _______, KC_UNDS, KC_LBRC, KC_RBRC, _______, _______, _______, TG_ADJ,
    ...
    [_ADJUST] = LAYOUT_typek_visual(
        ...
        _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, TG_ADJ,
                 _______, _______,          _______, _______,                   _______, _______, _______,                            _______
    ),
};
