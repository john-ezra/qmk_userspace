...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_bksp_275_rspace(
        ...
        KC_LSFT, KC_K,    KC_V,    KC_M,    KC_F,    KC_G,    KC_B,    KC_J,    KC_SCLN, KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,
        KC_LCTL,          KC_LALT,                   KC_SPC,  MO(_FN),          KC_SPC,  KC_RALT,          KC_RGUI,          KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_FN] = LAYOUT_split_bksp_275_rspace(
        QK_BOOT, UG_TOGG, UG_NEXT, _______, _______, _______, _______, _______, _______, BL_BRTG, BL_TOGG, BL_UP,   BL_DOWN, _______, _______, KC_INS,
