...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT(
        ...
        KC_LCTL, MO(_FN), KC_LALT,                            KC_SPC,                    MO(_FN), KC_RCTL,                   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, KC_MINS, KC_LPRN, KC_RPRN, _______, _______, _______, _______,                   KC_END,
