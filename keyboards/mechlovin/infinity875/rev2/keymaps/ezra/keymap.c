...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_all(
        ...
        KC_LCTL,   _______, MO(_FN),                            KC_SPC,                             _______, MO(_FN), _______, KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_FN] = LAYOUT_all(
        ...
        _______,   _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, _______, _______, _______,            _______, _______, _______,
